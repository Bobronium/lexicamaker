...
def test_argparse4():
    """Checks import of the parser function and tests the simplest argument configuration.
        ...
        2) abbreviations and annotation are explicitly forbidden
        3) abbreviations and annotation are explicitly given
        4) dictionary has not .dsl extension, abbreviations and annotation are not present"""
    os.chdir(os.path.dirname(__file__))
